...
public class ResultUtil {
	 ...
	 * @return
	 */
	public static JSONObject getResponse(String code, String message, String exception, Object data) {
		JSONObject result = new JSONObject();
		result.put("code", code);
		result.put("message", message);
		result.put("exception", exception);
		result.put("data", Objects.isNull(data) ? "" : data);
		return result;
	}
	...
	public static JSONObject getResponse(String code, String message, String exception, Object data,
		...
		result.put("exception", exception);
		result.put("data", Objects.isNull(data) ? "" : data);
		result.put("pageInfo", Objects.isNull(pageInfo) ? "" : pageInfo);
		return result;
	}
