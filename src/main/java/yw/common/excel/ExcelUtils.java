...
public class ExcelUtils {
	...
	public static void exportExcel(String[] budgetHeaders,
			String[]  secondBudgetHeaders,List<Map<String,Object>>  budgetList,
			List<Map<String,Object>>  secondBudgetList, OutputStream out) {
